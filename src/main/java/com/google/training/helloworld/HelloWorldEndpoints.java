...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name = "greetByTeam", path = "greetByTeam",
            httpMethod = HttpMethod.GET)

    public HelloClass greetByTeam (@Named("name") String name, @Named("period") String timeofday, @Named("team") String team) {
        return new HelloClass(name, timeofday, team);
    }
